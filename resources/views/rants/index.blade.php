    ...
    <script type="text/javascript">
        ...
        $(function () {
            $(document).ready(function () {
                ...
                $("div#sidebar.sidebar ul.nav.nav-list li:eq(1)").addClass("active");
            });
	        ...
	        jQuery(function ($) {
	            ...
	            jQuery(grid_selector).jqGrid({
	                datatype: "local",
	                url: "/api/getRantList?rows="+<?php echo $params['rows'];?>+"&page="+<?php echo $params['page'];?>,
	                datatype: "json",
	                height: 350,
	                colNames: ['Id', 'Content', 'Image', 'User', 'Status'],
	                colModel: [
	                    ...
	                    {name: 'f_image_url', index: 'image', width: 30, formatter: playerPicFormatter, editable: true,edittype: 'file',
	                        editoptions: {
	                ...
	                editurl: "/api/rant", //nothing is saved
	                caption: "Rant List",
	                autowidth: true
			    ...
			    {
			      var html = "<img height='42' width='42' src='"+cellvalue+"'/>";
			      return html;
			    }
